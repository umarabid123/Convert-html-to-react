    ...
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <a href="#" class="footer-logo">
          <img src="/src/assets/images/logo-light.svg" alt="SimpleBlog Logo" width="150" class="logo-light"/>
          <img src="/src/assets/images/logo-dark.svg" alt="SimpleBlog Logo" width="150" class="logo-dark"/>
        </a>
